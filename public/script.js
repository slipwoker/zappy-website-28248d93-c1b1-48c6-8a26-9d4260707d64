document.addEventListener('DOMContentLoaded', function () {
  ...
  const animatableElements = Array.from(
    document.querySelectorAll(ANIMATION_SELECTORS.join(', '))
  );

  function applyInlineAnimationStyles(el) {
    if (!el.style.transitionDuration) {
      const delay = el.getAttribute('data-delay') || el.getAttribute('data-animate-delay') || '0';
      const duration = el.getAttribute('data-duration') || el.getAttribute('data-animate-duration') || '600';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '28248d93-c1b1-48c6-8a26-9d4260707d64',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '28248d93-c1b1-48c6-8a26-9d4260707d64';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '28248d93-c1b1-48c6-8a26-9d4260707d64';
